...
The plan object participates in HyperDoc's SHOP3 layer as a
`hyperdoc/shop3:hyperdoc-htn-plan-result` protocol projection. It is not
generated by `shop3:find-plans` and does not execute command specs.
