(defpackage #:kioskberrli.dmx-sql-topicmap-hyperdoc
  (:use #:cl)
  (:export
...
(in-package #:kioskberrli.dmx-sql-topicmap-hyperdoc)
...
(defun dmx-sql-topicmap-hyperdoc-topics (projection)
  ...
  (let* ((payload
           (kioskberrli.dmx-sql-topicmap:projection-topicmap-payload
            projection))
...
(defun dmx-sql-topicmap-hyperdoc-native-model (projection)
  ...
  (let ((summary
          (kioskberrli.dmx-sql-topicmap:projection-summary projection)))
...
(defun dmx-sql-topicmap-hyperdoc-projection (projection)
  "Project the Kioskberrli SQL mirror projection into HyperDoc's native topicmap IR.
  ...
  (let* ((payload
         ...
         (source
           (hyperdoc:source-content-from-object
            projection
            :title (kioskberrli.dmx-sql-topicmap:projection-title projection)
...
(defmethod hyperdoc:topicmap-projection-of
    ((projection kioskberrli.dmx-sql-topicmap:dmx-sql-topicmap-projection))
  (dmx-sql-topicmap-hyperdoc-projection projection))

(defmethod hyperdoc:topicmap-view-title-of
    ((projection kioskberrli.dmx-sql-topicmap:dmx-sql-topicmap-projection))
  (kioskberrli.dmx-sql-topicmap:projection-title projection))

(defmethod hyperdoc:topicmap-view-input-owner-of
    ((projection kioskberrli.dmx-sql-topicmap:dmx-sql-topicmap-projection))
  "kioskberrli-dmx-sql-topicmap")
...
This fallback is kept for debugging when the DM6 island is not mounted."
  (let* ((model (dmx-sql-topicmap-hyperdoc-native-model projection))
    ...
    (with-output-to-string (stream)
      (format stream "<section class='kioskberrli-dmx-sql-topicmap'>~%")
