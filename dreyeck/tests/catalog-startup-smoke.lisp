...
(DEFUN FRESH-CATALOG-EVALUATIONS NIL
       (APPEND
               (APPEND
                       ...
                       (LIST
                             ...
                             "(uiop:symbol-call :dreyeck/upstream-intake/tests :check-page-loading-repository-context)"
                             "(asdf:load-system \"dreyeck/lisp-critic/reading/tests\")"
                             "(uiop:symbol-call :dreyeck/lisp-critic/reading/tests :check-under-catalog-runtime)"
 ...
 (ASSERT (HYPERBOOK:FIND-PAGE
          (HYPERBOOK:FIND-HYPERBOOK \"dreyeck/work/reading\" :SIGNAL-ERROR? T)
          \"Work Breakdown\" :SIGNAL-ERROR? T))
 (ASSERT (NULL (FIND-PACKAGE :DREYECK/WORK/PLANNING)))
 (LET ((TEMPORAL
 ...
 (FORMAT T
         \"NORMAL-LAUNCHER-PROOF: 17 books; TALA 12 and workflow 12 source/play thunks; no authoring runtime.~%\"))"))
               (LIST
