...
(DEFUN FORM-KEY (FORM)
       ...
       (WHEN (AND (CONSP FORM) (SYMBOLP (FIRST FORM)))
             (COND
                   ...
                   ((STRING= (SYMBOL-NAME (FIRST FORM)) "DEFVIEW")
                    (LIST :VIEW (SECOND FORM)
                          (AND (CONSP (THIRD FORM)) (SECOND (THIRD FORM)))))
