(:refactor-hyperdoc-fourth-dreyeck-extraction-post-review
 (:operation (!review-fourth-extraction-slice-after-execution))
 (:reviewed-commit "965822bd")
 (:moved-file
 ...
 (:next
  (:if-accepted (!assimilate-fourth-refactoring-episode-into-htn)
   :if-needs-repair (!repair-fourth-dreyeck-extraction-slice))))
