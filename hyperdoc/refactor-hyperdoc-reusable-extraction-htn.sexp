(:ARTIFACT (:ID REFACTOR-HYPERDOC-REUSABLE-EXTRACTION-HTN) (:TYPE :HTN-SHOP3-TASK-LIBRARY)
 (:STATUS
  :DRAFT-FILED-OUT-FROM-TEMPORARY-TOPIC-DB-EIGHTH-EXTRACTION-COMMIT-3-EXECUTION-PROBLEM-MATERIALIZED)
 ...
 (:SPECIALIZED-TASKS
  ((:TASK !SELECT-THIRD-LOW-RISK-DREYECK-EXTRACTION-SLICE :SPECIALIZES
   ...
   (:TASK !ASSIMILATE-EIGHTH-DREYECK-EXTRACTION-COMMIT-2-INTO-REUSABLE-HTN
    ...
    :STATUS :ACCEPTED)
   (:TASK !LOCALIZE-EIGHTH-DREYECK-EXTRACTION-COMMIT-3 :SPECIALIZES
    !LOCATE-REUSABLE-HTN-TASKS-BEFORE-SPECIALIZATION :EVIDENCE
    "hyperdoc/evidence/refactor-hyperdoc-eighth-extraction-commit-3-localization.sexp"
    :SPECIALIZED-EXISTING-PLAN-FOUND NIL
    :STATUS :LOCALIZED-NO-SPECIALIZED-PLAN-FOUND)
   (:TASK !MATERIALIZE-EIGHTH-EXTRACTION-COMMIT-3-SHOP3-PROBLEM :SPECIALIZES
    !ADAPT-CURRENT-PLAN-WITH-REUSED-OR-GENERALIZED-TASKS :EVIDENCE
    "hyperdoc/evidence/refactor-hyperdoc-eighth-extraction-commit-3-shop3-problem-materialization.sexp"
    :ASDF-SYSTEM :DREYECK/SHOP3/EXTRACTION-PLANNING
    :LIVE-FIND-PLANS T
    :HEURISTIC-FALLBACK NIL
    :STATUS :COMMIT-3-SHOP3-PROBLEM-MATERIALIZED)))
 (:METHOD-TEMPLATE
 ...
 (:EIGHTH-EXTRACTION-COMMIT-3-CANDIDATE
  ...
  (:LIVE-SHOP3-PROBLEM
   (:ASDF-SYSTEM :DREYECK/SHOP3/EXTRACTION-PLANNING)
   (:DOMAIN EIGHTH-DREYECK-EXTRACTION-COMMIT-3-LOCALIZATION-DOMAIN)
   (:PROBLEM EIGHTH-DREYECK-EXTRACTION-COMMIT-3-LOCALIZATION)
   (:TOP-LEVEL-TASK-KIND :COMPOUND)
   (:METHODS 1)
   (:PRIMITIVE-OPERATORS 5)
   (:PLAN-LENGTH 5)
   (:HEURISTIC-FALLBACK NIL))
  (:LIVE-SHOP3-PREPARATION
   (:EVIDENCE
   ...
   (:ASDF-SYSTEM :DREYECK/SHOP3/EXTRACTION-PLANNING)
   (:DOMAIN EIGHTH-DREYECK-EXTRACTION-COMMIT-3-PREPARATION-DOMAIN)
   (:PROBLEM EIGHTH-DREYECK-EXTRACTION-COMMIT-3-PREPARATION)
   (:TOP-LEVEL-TASK-KIND :COMPOUND)
   (:METHODS 1)
   (:PRIMITIVE-OPERATORS 6)
   (:PLAN-LENGTH 6)
   (:HEURISTIC-FALLBACK NIL)
   (:DELETION-TARGETS 6)
   (:REFERENCE-POLICY :STAGED-ADDED-LINES)
   (:REFERENCE-CLASSIFICATION :PATH-AND-KIND))
  (:LIVE-SHOP3-EXECUTION-PROBLEM
   (:EVIDENCE
   ...
   (:ASDF-SYSTEM :DREYECK/SHOP3/EXTRACTION-PLANNING)
   (:DOMAIN EIGHTH-DREYECK-EXTRACTION-COMMIT-3-EXECUTION-DOMAIN)
   (:PROBLEM EIGHTH-DREYECK-EXTRACTION-COMMIT-3-EXECUTION)
   (:TOP-LEVEL-TASK-KIND :COMPOUND)
   (:OPERATOR-SCHEMAS 12)
   (:METHODS 1)
   (:PLAN-LENGTH 18)
   (:MODELED-DELETION-ACTIONS 6)
   (:HEURISTIC-FALLBACK NIL)
   (:EXECUTOR-INVOKED NIL)
   (:REPOSITORY-EXECUTION-MUTATIONS NIL))
  (:STATUS :EIGHTH-EXTRACTION-COMMIT-3-EXECUTION-PROBLEM-MATERIALIZED))
 (:NEXT
