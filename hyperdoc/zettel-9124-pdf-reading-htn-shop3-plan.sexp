(:ARTIFACT ZETTEL-9124-PDF-READING-HTN-SHOP3-PLAN :KIND
 ...
 :EPISODE ZETTEL-9124 :ORGANIZING-ANALOGY "Knuth: How to Read a Web" :REPO-ROOT
 "/Users/rgb/workspace/hyperdoc" :DMX-SQLITE
 ...
 (DEFDOMAIN ZETTEL-9124-PDF-READING
  ((:OPERATOR (!RECORD-SOURCE-IDENTITY ?PDF) NIL NIL
   ...
   (:OPERATOR (!FINGERPRINT-PDF-SOURCE ?PDF) ((SOURCE-IDENTITY-RECORDED ?PDF))
    NIL ((PDF-FINGERPRINT-RECORDED ?PDF)))
   ...
   (:OPERATOR (!DERIVE-ASSOCIATIONS-BETWEEN-TOPICS ?PDF)
    ((TOPIC-CANDIDATES-DERIVED ?PDF)) NIL ((TOPIC-ASSOCIATIONS-DERIVED ?PDF)))
   (:OPERATOR (!RELATE-FRAGMENTS-TO-SOURCE-PAGES ?PDF)
    ((PDF-PAGE-RANGE-UNITS-AVAILABLE ?PDF) (JARGON-FRAGMENTS-DERIVED ?PDF)) NIL
 ...
 (:COVERAGE :COMPLETE-REQUIRED :KNOWN-SEED-FUNCTIONS
  ((:SYMBOL "SHOP3:FIND-PLANS" :MANUAL-ROLE :SINGLE-PROBLEM-PLANNER-ENTRYPOINT
    :LIVE-LISP-LINK "(find-symbol \"FIND-PLANS\" \"SHOP3\")" :DMX-TOPIC-ID
   ...
   (:SYMBOL "DEFPROBLEM" :MANUAL-ROLE :PROBLEM-DEFINITION-FORM :LIVE-LISP-LINK
    "(find-symbol \"DEFPROBLEM\" \"SHOP3\")" :DMX-TOPIC-ID
    "shop3:function:defproblem"))
  :NEXT-REQUIRED-TASK
  (!HARVEST-SHOP3-MANUAL-FUNCTION-INDEX-AND-CLOSE-COVERAGE :SOURCE
   "https://shop-planner.github.io/" :MUST-LINK-ALL-MANUAL-DOCUMENTED-FUNCTIONS
   T))
 :DMX-TOPICS
