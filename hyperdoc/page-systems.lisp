...
(defun fedwiki-the-1998-ai-planning-systems-competition-display-ready-p
  ...
  (declare (ignore system))
  (let* ((db-path
           #P"/Users/rgb/.wiki/wiki.ralfbarkow.ch/assets/pages/the-1998-ai-planning-systems-competition/the-1998-ai-planning-systems-competition.dmx.sqlite")
         (asd-path
           #P"/Users/rgb/.wiki/wiki.ralfbarkow.ch/assets/pages/the-1998-ai-planning-systems-competition/the-1998-ai-planning-systems-competition.asd")
         (page-path
           #P"/Users/rgb/.wiki/wiki.ralfbarkow.ch/pages/the-1998-ai-planning-systems-competition")
         (source (page-system-read-file-string page-path))
         (missing nil))
    (unless (uiop:file-exists-p db-path)
      (push "Attached DMX topic SQLite database is missing." missing))
    (unless (uiop:file-exists-p asd-path)
      (push "Page-local ASDF entrypoint is missing." missing))
    (unless source
      (push "FedWiki page projection is missing from the page store."
            missing))
    (unless (and source
  ...
  (make-page-system
   ...
   (list (hyperdoc-runtime-provider)
         ...
         (make-page-runtime-provider
          ...
          :provider-kind :fedwiki-page-attached-asdf-system
          :asdf-system-name "the-1998-ai-planning-systems-competition"
          :ensure-function
          "(hyperdoc:load-fedwiki-attached-asdf-system (the-1998-ai-planning-systems-competition:fedwiki-attached-home))"
          :readiness-function
          "Attached DMX topic SQLite database exists and can reconstruct the FedWiki page projection"
          :display-notes
          "Provides a page-local ASDF entrypoint, attached DMX topic SQLite database, and reproducible FedWiki page projection."))
   :page-system-runtime-entry-points
   '("(hyperdoc:load-fedwiki-attached-asdf-system (the-1998-ai-planning-systems-competition:fedwiki-attached-home))"
     "(the-1998-ai-planning-systems-competition:inspect-page-attached-system)"
     "(the-1998-ai-planning-systems-competition:materialize-fedwiki-page-projection)"
     "(the-1998-ai-planning-systems-competition:validate-reconstruction-idempotence)")
   :page-system-display-contract
   '("FedWiki page projection is materialized into the FedWiki page store"
     "Attached DMX topic SQLite database remains under the page-attached asset root"
   ...
   :page-system-description
   "Page-system reload boundary for the McDermott 2000 AIPS Planning Competition page-attached ASDF system."))
