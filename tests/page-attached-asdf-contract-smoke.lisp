...
(defun page-attached-contract-page-pathname ()
  (merge-pathnames
   (format nil "pages/~A" +page-attached-contract-mcdermott-slug+)
   +page-attached-contract-site-root+))

(defun page-attached-contract-sqlite-pathname (home)
  (merge-pathnames
...
(defun run-page-attached-asdf-mcdermott-layout-smoke-test ()
  (let* ((home (page-attached-contract-mcdermott-home))
         ...
         (sqlite-path (page-attached-contract-sqlite-pathname home)))
